...
<div transition:slide class="home mb-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 place-content-center">
      <div class="w-full h-full">
        ...
        <div class="mt-5 pr-8 max-w-full">
          <h1 class="pb-5 text-[6vw] sm:text-6xl font-light text-gray-700 font-shelley font-bold font-italic text-center">New Era University</h1>
  ...
  <div>
    <Branch branchImage={`${HOST_ROOT}/${$branch_data.cover_image.path}`} branchName={$branch_data.name} />
  </div>
