<main>
    ...
    <h2 class="mb-5"><strong>Admission Procedure (NEU SHS Graduates)</strong></h2>
    <h3 class="text-left ml-50"><strong>Step 1: Request for Temporary Student ID</strong></h3>
    <p class="text-left ml-50 mr-100">Request for your Temporary Student ID thru sending the following details to admissionrequirements@neu.edu.ph</p>
    <ul class="text-left ml-60 mb-10 list-disc">
    ...
    <h3 class="text-left ml-50"><strong>Step 2: Edit your personal sheet thru NEU Automate</strong></h3>
    <p class="text-left ml-50 mr-100">Once you received the Temporary Username and Password thru email, You can now edt your
                                Personal Information Sheet thru this link NEU Automate for Application</p>
    <ul class="text-left ml-60 mb-10 list-roman">
    ...
    <h3 class="text-left ml-50"><strong>Step 3: Submission</strong></h3>
    <p class="text-left ml-50 mr-100">Submit all the following requirements thru this link Admission Requirements Submission Link
                                Admission Requirements for Freshmen</p>
    <ul class="text-left ml-60 list-disc">
    ...
    <p class="text-left ml-50">Admission Requirements for Transferees and Graduate School</p>
    <ul class="text-left ml-60 mb-10 list-disc">
        <li>General Student Personal Information Sheet (GSPIS)</li>
        <li>PSA Authenticated Birth Certificate</li>
    ...
    <h3 class="text-left ml-50"><strong>Step 4: Admission Approval</strong></h3>
    <p class="text-left ml-50 mr-100 mb-20">Upon receipt of the advise from the College Admissions Office on the Approval of admission, you
    may now log-in thru this link NEU Automate for Student Enrollment using the log-in credentials
    (Username and Password) that you have created in filling out your General Information Sheet.</p>
</main>
