...
<div class="{clazz} bg-black relative group" on:click={() => activated = true} on:pointerover|once={() => hovered = true}>
  {#key videoID}
    <div class="bg-center bg-no-repeat w-full h-full bg-black" style="background-image: url(https://i.ytimg.com/vi/{videoID}/hqdefault.jpg); background-size: auto 100%" ></div>
