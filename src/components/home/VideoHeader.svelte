...
<div class="cmp-videoheader h-50vh relative w-full">
  <video playsinline autoplay loop muted class="w-screen h-full object-cover absolute -z-2" bind:this={video}>
  ...
  <div class="w-full h-full flex items-center">
    <div class="w-full flex flex-col items-center text-white ">
      <div class="font-light text-3xl md:text-6xl mb-2 font-bold">CAMPUS AERIAL SHOT</div>
    </div>
  </div>
</div>
